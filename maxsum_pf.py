...
if len(param) < 2:
    ...
    print "python maxsum.py [size of random number list]"
    exit(-1)

numbers = generate_random_list(int(param[1]))
...
for idx, arr in enumerate(numbers):
    ...
    for n in sub_array:
        greatest_number += n
    print "[BF]The max of this array is:" + str(greatest_number)
#    print sub_array
    print "\n"
    ...
    for n in sub_array:
        greatest_number += n
    print "[BF2]The max of this array is:" + str(greatest_number)
#    print sub_array
    print "\n"
    ...
    for n in sub_array:
        greatest_number += n
    print "[DC]The max of this array is:" + str(greatest_number)
#    print sub_array
    print "\n"
    ...
    for n in sub_array:
        greatest_number += n
    print "[DP]The max of this array is:" + str(greatest_number)
#    print sub_array
    print "\n"
